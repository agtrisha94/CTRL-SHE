    ...
    <div className="min-h-screen bg-gradient-to-br from-[#faf6f1] via-[#fffaf5] to-[#fdf4ec]">
      ...
      <section className="relative overflow-hidden px-6 py-20 md:py-32">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          ...
          >
            From your first login to your perfectly paired meal—discover how AI, molecular science, and smart logistics work together to transform your nutrition.
          </motion.p>
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="px-8 py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-full font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 inline-flex items-center gap-2 cursor-pointer"
            >
              Get Started Free
      ...
      <section className="relative px-6 py-20">
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.8, ease: [0.22, 1, 0.36, 1] }}
          className="max-w-4xl mx-auto bg-gradient-to-br from-orange-500 to-orange-600 rounded-3xl p-12 text-center shadow-[0_20px_60px_rgba(249,115,22,0.3)] relative overflow-hidden"
        >
          {/* Background Pattern */}
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-orange-50 mb-8 max-w-2xl mx-auto">
              Join thousands experiencing 30% better adherence through molecular nutrition science
            </p>
            <motion.button
              onClick={handleGetStarted}
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.98 }}
              className="px-8 py-4 bg-white text-orange-600 rounded-full font-bold text-lg shadow-lg hover:shadow-xl transition-all duration-300 inline-flex items-center gap-2 cursor-pointer"
            >
              Get Started Free
              <ChevronRight className="w-5 h-5" />
            </motion.button>
